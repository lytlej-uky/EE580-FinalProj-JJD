...
void UART_Init(void){
  ...
  UART0_IBRD_R = 130;//43;                    // IBRD = int(80,000,000 / (16 * 115,200)) = int(43.403)// 38400  130.2083
  UART0_FBRD_R = 13;//26;                    // FBRD = round(0.4028 * 64 ) = 26
...
//------------simpleUART1_OutChar------------
// Output 8-bit to serial port U1 and U0
// Input: letter is an 8-bit ASCII character to be transferred
// Output: none
void simpleUART1_OutChar(char data){
...
//------------UART_OutChar------------ 
// Output 8-bit to serial port Uart0
// Input: letter is an 8-bit ASCII character to be transferred
// Output: none
// spin if TxFifo full
...
// non blocking output ASCII character to UART0
// Input: letter is an 8-bit ASCII character to be transferred
// Output: none
